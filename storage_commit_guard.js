"use strict";
(()=>{
 const KEY="ai3d:projects:v3",$=id=>document.getElementById(id),ALLOWED=new Set(["lightSign","spike","plug","sleeve","plate","adapter","enclosure"]),BLOCKED_KEYS=new Set(["__proto__","prototype","constructor"]),MAX_PROJECT_NAME=120,MAX_PROJECT_DESCRIPTION=1000,PRINT_KEYS=new Set(["printer","nozzle","layer","walls","infill","notes"]);
