...
assert.match(index,/cad_v2_editor\.js\?v=1\.3/,"index.html must load the current CAD v2 editor cache version");
assert.match(runtime,/\["cadV2",\(\)=>!cadV2Ready\(\),"cad_v2_editor\.js\?v=1\.3"\]/,"runtime fallback must use the same CAD v2 editor version");
...
assert.match(v2.src,/^cad_v2_editor\.js\?v=1\.3&healthRetry=\d+$/,"recovery script must be cache-busted without changing its pinned version");
