...
assert.equal(elements.btnCentauriStl.disabled,true,"failed preflight must disable the real Centauri STL control");
...
assert.equal(elements.btnCentauriStl.disabled,true,"unsupported project material must disable the real Centauri STL control");
