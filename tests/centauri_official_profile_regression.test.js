...
assert.match(source,/recommendedLayer:0\.2,layerRange:\[0\.1,0\.4\],recommendedSpeed:250,maxSpeed:500,accuracy:0\.1,autoLevelPoints:121,multicolor:4/,
  "Centauri layer, speed, accuracy, leveling and CANVAS profile must stay explicit and regression-protected");
