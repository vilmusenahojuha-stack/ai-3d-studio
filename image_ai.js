...
(()=>{
  ...
  box.innerHTML=`
    ...
    <p class="ai-help">Lisää kuva osasta. AI ei arvaa mittakaavaa kuvasta, vaan kysyy tarvittavat mitat ennen 3D-mallin luontia.</p>
    <div class="image-ai-grid">
      <label class="image-drop" id="imageDrop"><input id="imageFile" type="file" accept="image/*" capture="environment"><span id="imageDropText">NAPAUTA JA VALITSE / OTA KUVA</span><img id="imagePreview" class="image-preview" hidden alt="Valittu osa"></label>
  ...
  document.querySelector(".badge").textContent="v1.0";
  const footer=document.querySelector("footer p");if(footer)footer.textContent="AI 3D Studio v1.0 — kuva-AI:n turvallinen mittakysely- ja CAD-hyväksyntäketju.";
})();